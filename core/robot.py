...
class RobotCore:
  ...
  def _initSensors(self) -> None:
    self.gyro = Gyro_NAVX2(constants.Sensors.Gyro.NAVX2_COM_TYPE)
  ...
  def _setupOperator(self) -> None:
    ...
    self.operator.rightBumper().whileTrue(self.game.reverseHopper())
    self.operator.a().whileTrue(self.game.alignTurretToActiveTarget())
    self.operator.b().whileTrue(self.game.launchFuelDemo())
